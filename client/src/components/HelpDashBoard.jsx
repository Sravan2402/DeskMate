      ...
      <div className="relative flex flex-col lg:flex-row items-center gap-12 lg:gap-20 p-8 md:p-12 lg:p-16 rounded-[38px] hero-gradient">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <input
            ...
            className="mb-4 w-full max-w-xs ml-3 lg:mx-0 border border-white/70 bg-[#0a0a0c] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
          />
          <p className="text-sm text-zinc-400 mb-6 mt-7">
