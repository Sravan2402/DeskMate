...
const Sidebar = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
      ...
      {/* Mobile drawer */}
      <aside
        className={`md:hidden fixed top-16 left-0 bottom-0 w-64 bg-[#09090b]/80 backdrop-blur-xl border-r border-zinc-800/50 flex flex-col z-40 px-4 py-6 transition-transform duration-300 ${
      ...
      {/* Desktop sidebar — identical to original */}
